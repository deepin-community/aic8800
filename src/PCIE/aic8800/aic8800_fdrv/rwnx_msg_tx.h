...
int rwnx_send_dbg_start_app_req(struct rwnx_hw *rwnx_hw, u32 boot_addr,
				u32 boot_type);
int rwnx_send_pwm_init_req(struct rwnx_hw *rwnx_hw, u8 pwm_gpidx, u8 mode,
			   u8 run, u32 tmr_cnt, u32 dty_cnt, u32 step_val,
			   u8 gpio_en, u8 gpio_dir, u8 gpio_val);
int rwnx_send_pwm_deinit_req(struct rwnx_hw *rwnx_hw, u8 pwm_gpidx, u8 gpio_en,
...
int rwnx_send_resume_restore(struct rwnx_hw *rwnx_hw, u8_l on, u8_l efuse_valid,
			     u8_l set_vendor_info, u8_l fwtrace_redir_en,
			     struct rwnx_vif *vif);
