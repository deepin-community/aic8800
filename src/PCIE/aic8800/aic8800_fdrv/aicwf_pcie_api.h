...
#ifndef LOG_INFO
#define LOG_INFO(fmt, args...) printk("aicpcie: " fmt, ##args)
#endif

#ifndef LOG_ERROR
#define LOG_ERROR(fmt, args...) printk("aicpcie: " fmt, ##args)
#endif

#ifndef LOG_WARN
#define LOG_WARN(fmt, args...) printk("aicpcie: " fmt, ##args)
#endif

void aicwf_pcie_cfg_x(struct aic_pci_dev *adev, u32 addr, u32 wr);
void aicwf_pcie_map_set(struct aic_pci_dev *adev, u8 idx, u32 base, u32 limt,
			u32 addr);
void aicwf_pcie_cfg(struct aic_pci_dev *adev);
int aicwf_pcie_dma(struct aic_pci_dev *adev, void *dst, void *src, u32 blen,
		   u8 dir);
